    ...
    <div>
      ...
      <div className="w-full flex bg-[rgb(213,34,81)] justify-center">
        <div className="w-[90%] lg:w-[75%] py-7 h-auto flex flex-col md:flex-row  justify-between items-center gap-6">
          ...
          <button
            className="bg-gray-950 border-2 border-gray-950 text-white py-2 px-6 w-full sm:w-auto rounded-full text-sm md:text-base font-medium transition-all duration-300 cursor-pointer flex items-center justify-center"
          >
